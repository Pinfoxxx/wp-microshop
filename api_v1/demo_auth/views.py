...
# Just an example. Do not use this in real API!!!
...
static_auth_token_to_username = {
    "c47e6fe90f58b37478e3c2210fb4ab2": "admin",
    "c8dc2a7b1a2e18568ef0d5b8936943b75": "john",
}
...
# HTTP header authorization / header authorization by token
